...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    ...
    <span>Streamlined Tasks</span> <span className="text-purple-500/60">✦</span>
    <span>Faster Results</span> <span className="text-blue-500/60">✦</span>
    <span>AI-Powered</span> <span className="text-purple-500/60">✦</span>
    <span>Enterprise Scale</span> <span className="text-blue-500/60">✦</span>
  </div>
);
...
export function CinematicFooter() {
  ...
  return (
    <>
      ...
      >
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-[#080808] text-white cinematic-footer-wrapper">
          <div className="footer-aurora absolute left-1/2 top-1/2 h-[60vh] w-[80vw] -translate-x-1/2 -translate-y-1/2 animate-footer-breathe rounded-[50%] blur-[80px] pointer-events-none z-0" />
          <div className="footer-bg-grid absolute inset-0 z-0 pointer-events-none" />

          <div
            ref={giantTextRef}
            className="footer-giant-bg-text absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap z-0 pointer-events-none select-none"
          >
            PHENERON
          </div>
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-4xl sm:text-5xl md:text-8xl font-black footer-text-glow tracking-tighter mb-8 sm:mb-12 text-center"
            >
              Ready to automate?
            </h2>
            ...
            >
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton
                  as="a"
                  href="#contact"
                  className="footer-glass-pill px-6 py-4 sm:px-10 sm:py-5 rounded-full text-white font-bold text-sm md:text-base flex items-center gap-3 group"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-gray-600 text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Pheneron. All rights reserved.
            </div>
